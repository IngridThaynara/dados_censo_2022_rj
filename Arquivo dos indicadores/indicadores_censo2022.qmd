---
title: "Indicadores Municipais – Censo 2022 (RJ)"
author:
  - name: "Diogo de Almeida da Conceição (<dialmeida@id.uff.br>)"
  - name: "Gustavo Belfort Parreiras Coutinho (<gbpcoutinho@id.uff.br>)"
  - name: "Ingrid Thaynara de Oliveira Brito (<ingridthaynara@id.uff.br>)"
  - name: "João Victor Oliveira Honorato (<joaohonorato@id.uff.br>)"
format:
  html:
    toc: true
    toc-location: left
